...
public class Util
{
    ...
    */
	...
	public static String nameLeftValueRightJustify(String param1, String param2,
		...
		return param1+rightJustify(param2, (cpl - len));
	}
	...
	public static String validateNumric(int latlngtim)
	{
		return String.valueOf(latlngtim);
	}

	public static String validateNumric(String latlngtim)
	{
		if(latlngtim.isEmpty() || latlngtim == null){return "0";}
		return latlngtim;
	}

	public static String validateAlfa(String str)
	{
