...
import com.dm.library.TourCityDropDownAprovalListAdapter;
import com.dm.library.TourDistributorDropDownAprovalListAdapter;
import com.dm.library.TourPurposeDropDownAprovalListAdapter;
...
Bundle bundle;Intent intent;int tourAndroidCode=0;ConnectionDetector connectionDetector;ProgressDialog progressDialog;
    ...
    private boolean expanded;private PopupWindow pw,pw1,pw2; TextView tv1,tv2,tv3;TourCityDropDownAprovalListAdapter adapter;
    ArrayList<Distributor> ArraydistList;ArrayList<String> distList;
    ArrayList<Purpose> ArrayPurposeList;ArrayList<String> purposeList;
    TourDistributorDropDownAprovalListAdapter distadapter;
    TourPurposeDropDownAprovalListAdapter tourPurposeDropDownListAdapter;
    EditText remark;TourPlan tourPlan1;boolean ForUpdate=false;
    Button add,cancel;
    TourPlan tourPlan;TourPlanController tourPlanController;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getWindow().setTitle("Tour Plan Approval");
       ...
       /* ImageView iv = (ImageView)findViewById(R.id.image);
        ...
        appDataController1=new AppDataController(TourPlanPopupAproval.this);
        preferences = getSharedPreferences("MyPref", MODE_PRIVATE);
        appDataController1=new AppDataController(TourPlanPopupAproval.this);
        tourPlanController=new TourPlanController(TourPlanPopupAproval.this);
...
//            bundle.putStringArrayList("tourDateList",tourDateList);
            Intent intent=new Intent(TourPlanPopupAproval.this, TourPlanAproval.class);
...
void clearData()
{
    ...
    class GetDistributorList extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(TourPlanPopupAproval.this);
        @Override
    ...
    class GetCity extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            progressDialog= ProgressDialog.show(TourPlanPopupAproval.this,"Loading Data", "Loading Please wait...", true);
        ...
        city.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!expanded) {
                    ...
                    if (flag == 1)
                        city.setText(TourCityDropDownAprovalListAdapter.trimEnd(selected.trim(), ','));
                    expanded = true;
                } else {
                    city.setText(TourCityDropDownAprovalListAdapter.getSelected());
                    expanded = false;
                }
            }
        });
    ...
    private void initiatePopUp(ArrayList<String> items, TextView tv, ArrayList<City> ArraycityList1) {
        LayoutInflater inflater = (LayoutInflater) TourPlanPopupAproval.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//    		final TourCityDropDownListAdapter adapter = new TourCityDropDownListAdapter(this, items, tv,ArraycityList1);
        adapter = new TourCityDropDownAprovalListAdapter(TourPlanPopupAproval.this, items, tv, ArraycityList1,TourPlanPopupAproval.this);
        ...
        purpose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!expanded) {
                    ...
                    if (flag == 1)
                        purpose.setText(TourPurposeDropDownAprovalListAdapter.trimEnd(selected.trim(), ','));
                    expanded = true;
                } else {
                    purpose.setText(TourPurposeDropDownAprovalListAdapter.getSelected());
                    expanded = false;
                }
            }
        });
...
//    	populate the drop-down list
        ListView list = (ListView) layout.findViewById(R.id.dropDownList);
//    		final TourCityDropDownListAdapter adapter = new TourCityDropDownListAdapter(this, items, tv,ArraycityList1);
        tourPurposeDropDownListAdapter = new TourPurposeDropDownAprovalListAdapter(TourPlanPopupAproval.this, items, tv, ArraycityList1);
        ...
        distributor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!expanded) {
                    ...
                    if (flag == 1)
                        distributor.setText(TourDistributorDropDownAprovalListAdapter.trimEnd(selected.trim(), ','));
                        expanded = true;
                } else {
                    distributor.setText(TourDistributorDropDownAprovalListAdapter.getSelected());
                    expanded = false;
                }
            }
        });
...
//    	populate the drop-down list
        ListView list = (ListView) layout.findViewById(R.id.dropDownList);
//    		final TourCityDropDownListAdapter adapter = new TourCityDropDownListAdapter(this, items, tv,ArraycityList1);
        distadapter = new TourDistributorDropDownAprovalListAdapter(TourPlanPopupAproval.this, items, tv, ArraycityList1);
