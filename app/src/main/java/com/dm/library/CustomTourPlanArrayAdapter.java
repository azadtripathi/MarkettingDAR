 ...
 */
public class CustomTourPlanArrayAdapter extends ArrayAdapter<DashboardModel> {
...
//    ArrayList<String> tourDateList;
    ...
    public CustomTourPlanArrayAdapter(Context context, ArrayList<DashboardModel> dashboardModels, int rowLayout, int textView, HolderListener dataTransferInterface) {
...
//                new IntentSend(context,TourPlanEntry.class).toSendAcivity();
                    ...
                    Intent intent = new Intent(context, TourPlanEntry.class);
...
//            holder.tvapammout.setText(dashboardModels.get(position).getApamount());
            ...
            if(dashboardModels.get(position).getStatus().toString().equalsIgnoreCase("Approve")){
               final String aproval = "true";
                row.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        // TODO Auto-generated method stub
                        Intent i = new Intent(context, com.dm.crmdm_app.TourPlanAproval.class);
                        ...
                        i.putExtra("AppStatus","Approval");
                        i.putExtra("Status","Approval");
                        i.putExtra("aproval",aproval);
                        i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        context.startActivity(i);


                       /* i.putExtra("Doc_id",dashboardModels.get(position).getDoc_id());
                        i.putExtra("User",dashboardModels.get(position).getAndroidId());
                        i.putExtra("Date", dashboardModels.get(position).getFromDate());
                        i.putExtra("SmId", dashboardModels.get(position).getUserId());*/
                    }
                });

            }
            else if(dashboardModels.get(position).getStatus().toString().equalsIgnoreCase("Reject")){
                final String aproval = "true";
                row.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
