 ...
 */
public class TourPurposeDropDownAprovalListAdapter extends BaseAdapter {
    ...
    public static void setSelected(String selected) {
        TourPurposeDropDownAprovalListAdapter.selected = selected;
    }
    ...
    public static void setSelectedId(String selectedId) {
        TourPurposeDropDownAprovalListAdapter.selectedId = selectedId;
    }

    public TourPurposeDropDownAprovalListAdapter(Context context, ArrayList<String> items,
        ...
        for (int i = 0; i < TourPlanPopupAproval.checkSelectedPurpose.length; i++) {
            if (TourPlanPopupAproval.checkSelectedPurpose[i]) {
                selectedCount++;
            }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            if (TourPlanPopupAproval.checkSelectedPurpose[position]) {
    ...
    public void setText(int position1) {
        if (!TourPlanPopupAproval.checkSelectedPurpose[position1]) {
            TourPlanPopupAproval.checkSelectedPurpose[position1] = true;
            selectedCount++;
        } else {
            TourPlanPopupAproval.checkSelectedPurpose[position1] = false;
            selectedCount--;
        }
        ...
        if (selectedCount == 0) {
            ...
            for (int i = 0; i < TourPlanPopupAproval.checkSelectedPurpose.length; i++) {
                if (TourPlanPopupAproval.checkSelectedPurpose[i] == true) {
