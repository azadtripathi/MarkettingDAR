...
public class CustomArrayAdapterLeaveAprovalList extends
	...
	public CustomArrayAdapterLeaveAprovalList(
			Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		row.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				/*SharedPreferences preferences = context.getSharedPreferences(
						"Update_Leave", context.MODE_PRIVATE);
				Editor editor = preferences.edit();
				editor.clear();

				editor.putString("LEAVEDOCID_SESSION",
						dashboardModels.get(position).getRemark());
				editor.putString("lEAVE_ANDROID_ID_SESSION", dashboardModels
						.get(position).getAndroidId());
				editor.putString("TODATE_SESSION", dashboardModels
						.get(position).getToDate());
				editor.putString("FROMDATE_SESSION", dashboardModels
						.get(position).getFromDate());
				editor.putString("APPLICATION_DATE_SESSION", dashboardModels
						.get(position).getVdate());
				editor.putString("LEAVE_USER_ID_SESSION", dashboardModels
						.get(position).getUserId());
				editor.putString("Days", dashboardModels
						.get(position).getNoOfDays());

				editor.putString("Reason", dashboardModels
						.get(position).getReason());
				editor.putString("Status", dashboardModels
						.get(position).getStatus());
				editor.commit();
				new IntentSend(context, LeaveRequest.class)
						.toSendAcivity();*/
				...
				i.putExtra("LEAVE_USER_ID_SESSION", dashboardModels.get(position).getSyncId());
		...
		/*holder.updateRecord.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				SharedPreferences preferences = context.getSharedPreferences(
						"RETAILER_SESSION_DATA", context.MODE_PRIVATE);
				Editor editor = preferences.edit();
				editor.clear();
				...
				editor.putString("Status", dashboardModels
						.get(position).getStatus());
				editor.commit();
				new IntentSend(context, UpdateLeaveRequest.class)
						.toSendAcivity();



				*//*Intent i = new Intent(context, UpdateLeaveRequest.class);
				i.putExtra("LVRQId", dashboardModels.get(position).getDoc_id());
				i.putExtra("NoOfDays", dashboardModels.get(position).getNoOfDays());
				i.putExtra("VDate", dashboardModels.get(position).getVdate());
				i.putExtra("FromDate", dashboardModels.get(position).getFromDate());
				i.putExtra("ToDate", dashboardModels.get(position).getToDate());
				i.putExtra("Reason", dashboardModels.get(position).getReason());
				i.putExtra("AppStatus", dashboardModels.get(position).getStatus());
				context.startActivity(i);
*//*
			}
		});*/
