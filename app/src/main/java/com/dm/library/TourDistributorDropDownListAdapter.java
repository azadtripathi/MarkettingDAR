 ...
 */
public class TourDistributorDropDownListAdapter extends BaseAdapter  {
    ...
    public static void setSelected(String selected) {
        TourDistributorDropDownListAdapter.selected = selected;
    }
    ...
    public static void setSelectedId(String selectedId) {
        TourDistributorDropDownListAdapter.selectedId = selectedId;
    }

    public TourDistributorDropDownListAdapter(Context context, ArrayList<String> items,
        ...
        for(int i = 0; i< TourPlanEntry.checkSelectedDist.length; i++)
        {
            if(TourPlanEntry.checkSelectedDist[i])
            {
                selectedCount++;
            }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            if(TourPlanEntry.checkSelectedDist[position])
            {
    ...
    public void setText(int position1){
        if (!TourPlanEntry.checkSelectedDist[position1]) {
            TourPlanEntry.checkSelectedDist[position1] = true;
            selectedCount++;
        } else {
            TourPlanEntry.checkSelectedDist[position1] = false;
            selectedCount--;
        }
        ...
        if (selectedCount == 0) {
            ...
            for (int i = 0; i < TourPlanEntry.checkSelectedDist.length; i++) {
                if (TourPlanEntry.checkSelectedDist[i] == true) {
