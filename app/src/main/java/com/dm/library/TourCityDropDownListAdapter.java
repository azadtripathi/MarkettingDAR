 ...
 */
public class TourCityDropDownListAdapter extends BaseAdapter implements Filterable {
    ...
    public static void setSelected(String selected) {
        TourCityDropDownListAdapter.selected = selected;
    }
    ...
    public static void setSelectedId(String selectedId) {
        TourCityDropDownListAdapter.selectedId = selectedId;
    }

    public TourCityDropDownListAdapter(Context context, ArrayList<String> items,
                                       TextView tv, ArrayList<City> ArraycityList1, DistributorAccessInterface distributorAccessInterface) {
        ...
        for(int i = 0; i< TourPlanEntry.checkSelected.length; i++)
        {
            if(TourPlanEntry.checkSelected[i])
            {
                selectedCount++;
            }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            if(TourPlanEntry.checkSelected[position])
            {
    ...
    public void setText(int position1){
        if (!TourPlanEntry.checkSelected[position1]) {
            TourPlanEntry.checkSelected[position1] = true;
            selectedCount++;
        } else {
            TourPlanEntry.checkSelected[position1] = false;
            selectedCount--;
        }
        ...
        if (selectedCount == 0) {
            ...
            for (int i = 0; i < TourPlanEntry.checkSelected.length; i++) {
                if (TourPlanEntry.checkSelected[i] == true) {
